...
export default function FuelLogsPage() {
  ...
  const totalCost = (data?.results ?? []).reduce((sum, log) => sum + (log.total_cost ?? 0), 0);
            ...
            <CardContent className="pt-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-bold">
                  {(data?.results ?? []).reduce((s, l) => s + (l.quantity ?? 0), 0).toFixed(0)} L
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div>
                ...
                <p className="text-lg font-bold">
                  ...
                  {data.results.length > 0
                    ? (
                        data.results.reduce((s, l) => s + (l.unit_price ?? 0), 0) /
                        data.results.length
                      ).toFixed(2)
                    : "—"}
                  /L
